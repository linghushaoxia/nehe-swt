...
class Renderer implements GLEventListener {
	...
	public void loadGLTextures(GL gl) throws IOException {
		String[] textureNames = new String[] { "demos/data/images/envwall.jpg", "demos/data/images/ball.jpg", "demos/data/images/envroll.jpg" };
	...
	public void display(GLAutoDrawable glDrawable) {
		...
		gl.glStencilOp(GL.GL_KEEP, GL.GL_KEEP, GL.GL_REPLACE); // We Set The Stencil Buffer To 1 Where We Draw Any
																// Polygon
		...
		gl.glBlendFunc(GL.GL_SRC_ALPHA, GL.GL_ONE_MINUS_SRC_ALPHA); // Blending Based On Source Alpha And 1 Minus Dest
																	// Alpha
