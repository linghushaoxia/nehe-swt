...
class Renderer implements GLEventListener {
	...
	private void loadTexture(String fileName, int[] texid, GLAutoDrawable drawable) throws IOException { // Creates
																											// Texture
																											// From A
																											// Bitmap
																											// File
		...
		gl.glTexImage2D(GL.GL_TEXTURE_2D, 0, 3, texture.getWidth(), texture.getHeight(), 0, GL.GL_BGR, GL.GL_UNSIGNED_BYTE, texture.getPixels());
	}
	...
	private void drawGLInfo(GL gl) {
		...
		string = "vLightSourceToIntersect = " + twoFracsMax(gCamera.vLightSourceToIntersect.x) + ", " + twoFracsMax(gCamera.vLightSourceToIntersect.y) + ", "
