...
class Vector3D {
	...
	public Vector3D(float x, float y, float z) // Constructor that initializes this Vector3D to the intended values of
												// x, y and z
	{
		this.x = x;
		this.y = y;
	...
	public void normalize() // normalize() normalizes this Vector3D that its direction remains the same but its length
							// is 1.
	{
		float length = length();
