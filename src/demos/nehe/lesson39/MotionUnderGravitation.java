...
class MotionUnderGravitation extends Simulation {
	...
	public MotionUnderGravitation(Vector3D gravitation) // Constructor firstly constructs its super class with 1 mass
														// and 1 kg
	...
	public void solve() // gravitational force will be applied therefore we need a "solve" method.
	{
		...
		while (masses.hasNext()) {
			...
			mass.applyForce(new Vector3D(gravitation).scale(mass.m)); // gravitational force is as F = m * g. (mass
