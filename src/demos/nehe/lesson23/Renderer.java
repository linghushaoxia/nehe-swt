...
class Renderer implements GLEventListener {
	...
	public void init(GLAutoDrawable glDrawable) {
		...
		gl.glTexGeni(GL.GL_S, GL.GL_TEXTURE_GEN_MODE, GL.GL_SPHERE_MAP); // Set The Texture Generation Mode For S To
																			// Sphere Mapping (NEW)
		gl.glTexGeni(GL.GL_T, GL.GL_TEXTURE_GEN_MODE, GL.GL_SPHERE_MAP); // Set The Texture Generation Mode For T To
																			// Sphere Mapping (NEW)
	}
	...
	public void display(GLAutoDrawable glDrawable) {
		...
		case 1:
			...
			break;
		case 2:
			glu.gluSphere(quadratic, 1.3f, 32, 32); // Draw A Sphere With A Radius Of 1 And 16 Longitude And 16 Latitude
													// Segments
			break;
		case 3:
