...
class Renderer implements GLEventListener {
	...
	private float[] data = { 0f, 0f, -1f, -1f, 1f, // FRONT FACE
			1f, 0f, 1f, -1f, 1f, 1f, 1f, 1f, 1f, 1f, 0f, 1f, -1f, 1f, 1f,

			1f, 0f, -1f, -1f, -1f, // BACK FACE
			1f, 1f, -1f, 1f, -1f, 0f, 1f, 1f, 1f, -1f, 0f, 0f, 1f, -1f, -1f,

			0f, 1f, -1f, 1f, -1f, // Top Face
			0f, 0f, -1f, 1f, 1f, 1f, 0f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, -1f,

			1f, 1f, -1f, -1f, -1f, // Bottom Face
			0f, 1f, 1f, -1f, -1f, 0f, 0f, 1f, -1f, 1f, 1f, 0f, -1f, -1f, 1f,
	...
	private void loadGLTextures(GL gl, GLU glu) throws IOException { // Load PNGs And Convert To Textures
		...
		texture = TextureReader.readTexture("demos/data/images/multi_on_alpha.bmp", true);// Load The
	...
	void doMesh1TexelUnits(GL gl) {
		...
		/*
		 * PASS#3: Use Texture "Base" Blend GL_DST_COLOR To GL_SRC_COLOR (Multiplies By 2) Lighting Enabled No Offset
		 * Texture-Coordinates
		 */
	...
	void doMesh2TexelUnits(GL gl) {
		...
		/*
		 * PASS#1: Texel-Unit 0: Use Texture "Bump" No Blend No Lighting No Offset Texture-Coordinates Texture-Operation
		 * "Replace" Texel-Unit 1: Use Texture "Invbump" No Lighting Offset Texture Coordinates Texture-Operation
		 * "Replace"
		 */
		...
		/*
		 * PASS#2 Use Texture "Base" Blend GL_DST_COLOR To GL_SRC_COLOR (Multiplies By 2) Lighting Enabled No Offset
		 * Texture-Coordinates
		 */
