 ...
 * This version implements the "old school" boolean array to pass around key presses in a similar manor to Erkin Tunca's
 * original c++ code (see "LRESULT CALLBACK WindowProc (HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)" in
 * NeHeGL.cpp)
 * 
 * @author Scott Rains
 */
