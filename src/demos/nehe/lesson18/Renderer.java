...
class Renderer implements GLEventListener {
	...
	public void display(GLAutoDrawable drawable) {
		...
		case 1:
			...
			break;
		case 2:
			glu.gluDisk(quadric, 0.5f, 1.5f, 32, 32); // Draw A Disc (CD Shape) With An Inner Radius Of 0.5, And An
														// Outer Radius Of 2. Plus A Lot Of Segments ;)
			break;
		case 3:
			glu.gluSphere(quadric, 1.3f, 32, 32); // Draw A Sphere With A Radius Of 1 And 16 Longitude And 16 Latitude
													// Segments
			break;
		case 4:
