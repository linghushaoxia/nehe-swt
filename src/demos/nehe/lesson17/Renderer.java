...
class Renderer implements GLEventListener {
	...
	public void display(GLAutoDrawable glDrawable) {
		...
		glPrint(gl, (int) ((280 + 250 * Math.cos(cnt1))), (int) (235 + 200 * Math.sin(cnt2)), "NeHe", 0); // Print GL
																											// Text To
																											// The
																											// Screen

		gl.glColor3f((float) (Math.sin(cnt2)), 1.0f - 0.5f * (float) (Math.cos(cnt1 + cnt2)), (float) (Math.cos(cnt1)));
		glPrint(gl, (int) ((280 + 230 * Math.cos(cnt2))), (int) (235 + 200 * Math.sin(cnt1)), "OpenGL", 1); // Print GL
																											// Text To
																											// The
																											// Screen
