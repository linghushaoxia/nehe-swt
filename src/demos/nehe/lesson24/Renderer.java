...
class Renderer implements GLEventListener {
	...
	public void display(GLAutoDrawable drawable) {
		...
		while (tokenizer.hasMoreTokens()) { // While The Token Isn't NULL
			...
			glPrint(gl, 50, 96 + (cnt * 32) - scroll, 0, tokenizer.nextToken()); // Print The Current Token (Parsed
																					// Extension Name)
		}
	...
	private void loadTGA(GL gl, TextureImage texture, String filename) throws IOException { // Loads A TGA File Into
																							// Memory
		...
		try {
			...
			imageSize = texture.width * texture.height * bytesPerPixel; // Calculate The Memory Required For The TGA
																		// Data
